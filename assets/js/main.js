...
sr.reveal(`.about__container img`, {origin: 'left'})
sr.reveal(`.section__subtitle, .section__title`, {origin: 'bottom'})
sr.reveal(`.skills__container`, {origin: 'bottom'})
sr.reveal(`.services__container`, {origin: 'left'})
sr.reveal(`.work__filters`, {origin: 'left'})
sr.reveal(`.work__container`, {origin: 'right'})
